...
export declare const getMockServerMiddlewareConfig: (dataSourcesConfig: DataSourceConfig[], annotationsConfig: MockserverConfig["annotations"], appRoot?: string) => CustomMiddleware<MockserverConfig>;
