...
class UI5Config {
     ...
     * @memberof UI5Config
     */
    removeBackendFromFioriToolsProxydMiddleware(backendUrl) {
        ...
        if (!fioriToolsProxyMiddleware) {
            ...
            if (proxyMiddlewareConfig?.backend) {
                proxyMiddlewareConfig.backend = proxyMiddlewareConfig.backend.filter((existingBackend) => existingBackend.url !== backendUrl);
     ...
     * @memberof UI5Config
     */
    addMockServerMiddleware(dataSourcesConfig, annotationsConfig, appRoot) {
        this.document.appendTo({
            path: 'server.customMiddleware',
            value: (0, middlewares_1.getMockServerMiddlewareConfig)(dataSourcesConfig, annotationsConfig, appRoot)
        });
        return this;
    }
    /**
