...
function getBasMode() {
    ...
    const buildCodePlane = env[exports.BUILD_CODE_PLAN];
    if (basPlan === FREE) {
        return FREE;
    }
    if (basPlan === TRIAL || basPlan === BUILD_CODE_FREE) {
        if (buildCodePlane === FREE) {
            return BUILD_CODE_FREE_VAL;
        }
        return FREE;
    }
    if (basPlan === BUILD_CODE) {
        if (buildCodePlane === STANDARD) {
