...
describe("Test for getKey", () => {
    const wsid = "ws-23232";
    let mockAxios;
    const startupServerUrl = `https://startup-workspaces-${wsid}.cry10.int.applicationstudio.cloud.sap`;
    const getMockResponse = () => ({
        ...
        runtime: {
            ...
            url: {
                ...
                theia: `https://theia-workspaces-${wsid}.cry10.int.applicationstudio.cloud.sap/`,
            },
        },
        diskusage: {
            used: 111111,
    ...
    it("Should return key from startup server", async () => {
        ...
        const key = await (0, devspace_utils_1.getKey)("http://any.host.net/", "jwt1989", wsid);
