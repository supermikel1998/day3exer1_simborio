...
export declare class UI5Config {
     ...
     * @memberof UI5Config
     */
    removeBackendFromFioriToolsProxydMiddleware(backendUrl: string): this;
    /**
     ...
     * @memberof UI5Config
     */
    addMockServerMiddleware(dataSourcesConfig: DataSourceConfig[], annotationsConfig: MockserverConfig['annotations'], appRoot?: string): this;
    /**
     ...
     * @memberof UI5Config
     */
    addServiceToMockserverMiddleware(dataSourceConfig: DataSourceConfig, appRoot?: string, annotationsConfig?: MockserverConfig['annotations']): this;
    /**
